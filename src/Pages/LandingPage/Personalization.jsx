  ...
  return (
    <section className="py-24 bg-[#0f172a] text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-bold mb-4">Personalized for Your Lifestyle</h2>
        <p className="text-slate-400 text-lg max-w-2xl mx-auto">
          Built for students and professionals with tailored insights that match your unique financial situation
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-6">
          <div className="mb-8">
            <h3 className="text-3xl font-bold mb-4">Smart Personalization</h3>
            <p className="text-slate-400 leading-relaxed">
              SpendWise adapts to your unique lifestyle. Whether you're a student managing a tight budget or a working professional planning investments, our AI tailors insights specifically for you.
            </p>
          </div>
          ...
          <div className="bg-[#1e293b]/50 p-6 rounded-2xl border border-white/5 flex gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Track hostel expenses, manage monthly allowances, and get tips on saving for that next trip or gadget.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#1e293b]/50 p-6 rounded-2xl border border-white/5 flex gap-4">
            ...
            <div>
              <h4 className="text-lg font-semibold mb-2">For Professionals</h4>
              <p className="text-slate-400 text-sm leading-relaxed">
                Analyze salary breakdowns, optimize tax savings, and plan investments with advanced financial tools.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#1e293b] rounded-3xl p-8 border border-white/10 shadow-2xl relative">
          ...
          <div className="flex justify-between items-end mb-6">
            <div>
              <div className="text-sm text-slate-400 mb-1">Monthly Overview</div>
          ...
          <div>
            <h4 className="font-semibold mb-4 text-slate-200">Top Categories</h4>
